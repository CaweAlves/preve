...
<template>
  <button
    ...
    @click="emit('select')"
    :class="cn(
      'relative flex flex-col items-center h-full min-w-25 rounded transition-all duration-150 cursor-pointer',
      isSelected
        ...
        : 'hover:bg-muted-foreground/10 border border-transparent hover:shadow-sm hover:shadow-zinc-950/20 transition-[filter] duration-200 hover:brightness-110',
    )"
  >
